...
|-	|-	|-	|
| ETL #1: Hogares 	| * Tabla de hogares (2012)<br>* Caracteristicas generales (2012)<br>* Tabla de viviendas (2012)<br>* Hogares (2014)<br>* Caracteristicas generales (2014)<br>* Viviendas (2014)<br>* Hogares (2016)<br>* Caracteristicas generales (2016)<br>* Viviendas (2016)<br>* Hogares (2017)<br>* Caracteristicas generales (2017)<br>* Viviendas (2017) 	| - Se carga la cantidad inicial de los hogares<br>- De las tablas de Viviendas se extrae los datos económicos de cada hogar<br>- Se cuenta la cantidad de integrantes de la familia a partir de las tablas de Características generales 	|
| ETL #2: Encuesta de espacios culturales 	| * Asistencia a espacios culturales (2012)<br>* Asistencia a espacios culturales niños de 5 a 11 años (2012)<br>* Espacios culturales formacion y practica (2014)<br>* Espacios culturales (niños de 5 a 11) (2014)<br>* Espacios culturales y formacion practica (2016)<br>* Ninos de 5 a 11 espacios culturales y formacion practica (2016)<br>* Espacios culturales y formacion practica (2017)<br>* Ninos de 5 a 11 espacios culturales y formacion_practica (2017) 	| - Se insertan los datos de asistencia a sitios culturales a la dimensión DIM_Encuesta_Espacios_Culturales<br>- Se adicionan también los datos de asistencia de menores de 12 años<br>- Se separan los datos sobre actividades lúdicas hacia la dimensión DIM_Encuesta_Espacios_Culturales_Menores 	|
| ETL #3: Encuesta de presentaciones y espectáculos 	| * Tiempo libre (2012)<br>* Presentaciones y espectáculos (2014)<br>* Presentaciones y espectáculos (2016)<br>* Presentaciones y espectáculos (2017) 	| - Se insertan los datos de asistencia a presentaciones y espectáculos a la dimensión DIM_Encuesta_Presentaciones_Espectaculos 	|
| ETL #4: Personas 	| * Caracteristicas generales (2012)<br>* Tiempo libre (2012)<br>* Caracteristicas generales (2014)<br>* Presentaciones y espectaculos (2014)<br>* Caracteristicas generales (2016)<br>* Presentaciones y espectaculos (2016)<br>* Caracteristicas generales (2017)<br>* Presentaciones y espectaculos (2017) 	| - Se insertan los datos de la persona encuestada en FACT_Persona<br>- Se asocian los ID de la tabla de hechos hacia las tablas de dimensiones<br>- Se insertan los datos económicos de cada persona a partir de las tablas de Presentaciones y espectáculos y de Tiempo libre en el caso del 2012 	|